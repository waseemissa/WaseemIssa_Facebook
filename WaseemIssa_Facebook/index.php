        ...
        <div>
            <div class="lg:p-12 max-w-md max-w-xl lg:my-0 my-12 mx-auto p-6 space-y-">
                ...
                <form action="php/login.php" method="POST">
                    <input type="email" id="login_email" name="email" placeholder="Email: example@mydomain.com"
                    ...
                    <div class="text-center mt-5 space-x-2">
                        <p class="text-base"> Not registered? <a href="form-register.php" class=""> Create a account
                            </a></p>
                    </div>
                </form>
            </div>
