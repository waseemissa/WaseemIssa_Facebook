...
$query = "SELECT u.profile_picture_url AS picture, n.id AS id, n.user_id AS user_id, n.created_by AS created_by, n.text AS text, n.is_opened AS is_opened FROM notifications n, users u WHERE n.created_by = u.id AND n.user_id = ? ORDER BY n.id DESC";
