    ...
    <div id="wrapper">
        ...
        <div class="main_content">
            ...
            <div class="container m-auto">
                ...
                <h1 class="lg:text-2xl text-lg font-extrabold leading-none text-gray-900 tracking-tight mb-5"> Followers </h1>
                ...
                <div class="lg:flex justify-center lg:space-x-10 lg:space-y-0 space-y-5">
                    ...
                    <div class="bg-white dark:bg-gray-900 shadow-md rounded-md overflow-hidden followers_div1" id="followers_div1">
