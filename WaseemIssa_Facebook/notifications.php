    ...
    <div id="wrapper">
        ...
        <div class="main_content">
            ...
            <div class="container m-auto">
                ...
                <h1 class="lg:text-2xl text-lg font-extrabold leading-none text-gray-900 tracking-tight mb-5"> Notifications </h1>
                ...
                <div class="lg:flex justify-center lg:space-x-10 lg:space-y-0 space-y-5">
                    ...
                    <div class="bg-white dark:bg-gray-900 shadow-md rounded-md overflow-hidden friend_requests_div" id="friend_requests_div">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-800 border-b border-gray-100 flex items-baseline justify-between py-4 px-6 dark:border-gray-800">
                            <h2 class="font-semibold text-lg">Friend Requests</h2>
                        </div>

                    </div>

                    <div class="mt-5" uk-sticky="offset:28; bottom:true ; media @m">
                            <div class="bg-white dark:bg-gray-900 shadow-md rounded-md overflow-hidden activities_div" id="activities_div">
                                ...
                                <div class="bg-gray-50 border-b border-gray-100 flex items-baseline justify-between py-4 px-6 dark:bg-gray-800 dark:border-gray-700">
                                    <h2 class="font-semibold text-lg">Activities</h2>
                                </div>
