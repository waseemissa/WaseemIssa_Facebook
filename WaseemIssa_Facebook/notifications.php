            ...
            <div class="container m-auto">
                ...
                <div class="lg:flex justify-center lg:space-x-10 lg:space-y-0 space-y-5">
                    ...
                    <div class="space-y-5 flex-shrink-0 lg:w-7/12">
                        ...
                        <div class="bg-white dark:bg-gray-900 shadow-md rounded-md overflow-hidden friend_requests_div"
                            id="friend_requests_div">
                        ...
                        <div class="mt-5" uk-sticky="offset:28; bottom:true ; media @m">
                            <div class="bg-white dark:bg-gray-900 shadow-md rounded-md overflow-hidden activities_div"
                                id="activities_div">
